		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#zcreatenotificationzcreatenotification-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zcreatenotificationzcreatenotification-display": {
								"semanticObject": "zcreatenotificationzcreatenotification",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zcreatenotification.zcreatenotification",
									"url": sap.ui.require.toUrl("zcreatenotification/zcreatenotification")
								}
							}
						}
					}
